...
function Home({ nextPageRef, setActivePage }) {
  ...
  const openCV = () => {
    const url = `${process.env.PUBLIC_URL}/AlexCorceiro-CV.pdf`;
    window.open(url, '_blank', 'noopener,noreferrer'); // Ouvre le CV dans un nouvel onglet
  }

  // Variantes pour l'animation des éléments
  const containerVariants = {
    hidden: { opacity: 0, y: 50 },
    visible: { opacity: 1, y: 0, transition: { duration: 0.7, ease: "easeInOut", delayChildren: 0.3, staggerChildren: 0.2 } },  // Effet séquentiel
  };
            ...
            <motion.div className='home-left-bottom' variants={buttonVariants}>
              ...
              <ul className='home-list'>
                <motion.li className='home-item' variants={iconVariants} whileHover="hover">
                  <a href="https://profile.indeed.com/?hl=fr_FR&co=FR&from=gnav-menu-jobsearch--indeedmobile" target="_blank" rel="noopener noreferrer">
                    <SiIndeed style={{ fontSize: '3rem' }} />
                  </a>
                </motion.li>
                <motion.li className='home-item' variants={iconVariants} whileHover="hover">
                  <a href="https://www.linkedin.com/in/alex-corceiro-a423aa20b/" target="_blank" rel="noopener noreferrer">
